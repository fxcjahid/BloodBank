<?php
	 ...
	 */
	require( dirname(__FILE__, 2) . '/core/class/user.password.php');
	...
	/**
	 * Inlcude Password Change Form
	 */
	require_once( dirname(__FILE__, 2) . '/donor/component/page/password/form.php');
